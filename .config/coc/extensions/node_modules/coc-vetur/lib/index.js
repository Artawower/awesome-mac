...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (devPath && fs_1.default.existsSync(devPath)) {
            file = path_1.default.join(devPath, 'dist/vueServerMain.js');
            if (!fs_1.default.existsSync(file)) {
                coc_nvim_1.workspace.showMessage(`vetur server module "${file}" not found!`, 'error');
                return;
            }
        }
        else {
            ...
            if (!file) {
                coc_nvim_1.workspace.showMessage('vls module not found!', 'error');
                return;
            }
        }
        const selector = [{
...
function registerCustomClientNotificationHandlers(client) {
    client.onNotification('$/displayInfo', (msg) => {
        coc_nvim_1.workspace.showMessage(msg, 'more');
    });
    client.onNotification('$/displayWarning', (msg) => {
        coc_nvim_1.workspace.showMessage(msg, 'warning');
    });
...
function getGlobalSnippetDir() {
    ...
    if (process.platform === 'win32') {
        return path_1.default.resolve(process.env['APPDATA'] || '', appName, 'User/snippets/vetur');
    }
    else if (process.platform === 'darwin') {
        return path_1.default.resolve(os_1.default.homedir(), 'Library/Application Support', appName, 'User/snippets/vetur');
    }
    else {
        return path_1.default.resolve(os_1.default.homedir(), '.config', appName, 'User/snippets/vetur');
    }
}
