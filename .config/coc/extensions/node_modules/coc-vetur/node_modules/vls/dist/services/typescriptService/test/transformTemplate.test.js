...
suite('transformTemplate', () => {
    suite('`this` injection', () => {
        function check(inputTsCode, expectedTsCode, scope = []) {
            ...
            const output = transformTemplate_1.getTemplateTransformFunctions(require('typescript')).parseExpression(source.text, scope, 0);
...
//# sourceMappingURL=transformTemplate.test.js.map