...
var parse$2 = _interopDefault(require('@emmetio/abbreviation'));
var parse$3 = _interopDefault(require('@emmetio/css-abbreviation'));
...
function startsWithBlockTag(value, config) {
    if (value.length && typeof value[0] === 'string') {
        ...
        if ((matches === null || matches === void 0 ? void 0 : matches.length) && !config.options['inlineElements'].includes(matches[0].toLowerCase())) {
            return true;
        }
    }
    return false;
...
exports.markupAbbreviation = parse$2;
exports.stylesheetAbbreviation = parse$3;
exports.default = expandAbbreviation;
exports.extract = extractAbbreviation;
exports.markup = markup;
exports.parseMarkup = parse;
exports.parseStylesheet = parse$1;
...
//# sourceMappingURL=emmet.cjs.js.map
