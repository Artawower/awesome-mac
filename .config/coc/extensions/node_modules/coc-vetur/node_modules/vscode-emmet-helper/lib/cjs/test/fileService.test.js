...
mocha_1.describe('Check if a path is an absolute path', () => {
    function testIsAbsolutePath(path, expected) {
        mocha_1.it(`should ensure ${path} is${expected ? ' ' : ' not '}an absolute path`, () => __awaiter(this, void 0, void 0, function* () {
            assert_1.default.strictEqual(fileService_1.isAbsolutePath(path), expected);
        }));
    }
