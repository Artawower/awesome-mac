...
exports.getEmmetCompletionParticipants = exports.getEmmetMode = exports.updateExtensionsPath = exports.expandAbbreviation = exports.parseAbbreviation = exports.getExpandOptions = exports.isAbbreviationValid = exports.extractAbbreviationFromText = exports.extractAbbreviation = exports.isStyleSheet = exports.emmetSnippetField = exports.doComplete = exports.FileType = void 0;
...
function doComplete(document, position, syntax, emmetConfig) {
    ...
    if (!isStyleSheet(syntax)) {
        if (!snippetKeyCache.has(syntax) || !markupSnippetKeysRegex || markupSnippetKeysRegex.length === 0) {
            const registry = customSnippetRegistry[syntax] ? customSnippetRegistry[syntax] : expand_full_1.createSnippetsRegistry(syntax);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            Object.keys(snippetsJson).forEach(syntax => {
                ...
                const snippetKeys = customSnippetRegistry[syntax].all({ type: 'string' }).map(snippet => {
                    return snippet.key;
                });
