...
exports.createProfile = exports.isStylesheet = exports.createOptions = exports.createSnippetsRegistry = exports.parse = exports.expand = exports.Node = void 0;
var defaultOptions = {
    /**
...
function createBlockLookup(tree) {
    ...
    tree.walk(node => {
        ...
        if (classNames.length) {
            ...
            lookup.set(node, find(classNames, blockCandidates1)
        ...
        attributes: {
            secondary(attrs) {
                return attrs.map(attr => attr.isBoolean
                    ...
                    : `${attr.name}=${profile.quote(attr.value)}`).join(' ');
            }
        }
    };
    return render(tree, options.field, outNode => {
...
Object.defineProperty(exports, '__esModule', { value: true });
//# sourceMappingURL=expand-full.js.map