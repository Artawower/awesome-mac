...
const schema_contributor_1 = __webpack_require__(28);
...
(function (DynamicCustomSchemaRequestRegistration) {
    DynamicCustomSchemaRequestRegistration.type = new vscode_languageserver_protocol_1.NotificationType('yaml/registerCustomSchemaRequest');
})(DynamicCustomSchemaRequestRegistration || (DynamicCustomSchemaRequestRegistration = {}));
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        let { subscriptions } = context;
        const config = coc_nvim_1.workspace.getConfiguration('yaml');
        ...
        if (!fs_1.default.existsSync(file)) {
            coc_nvim_1.workspace.showMessage(`Can't resolve yaml-language-server`, 'error');
            return;
        }
        let serverOptions = {
            module: file,
        ...
        if (packageJSON && packageJSON.contributes && packageJSON.contributes.yamlValidation) {
            ...
            if (Array.isArray(yamlValidation)) {
                yamlValidation.forEach(jv => {
                    ...
                    if (fileMatch && url) {
                        if (url[0] === '.' && url[1] === '/') {
                            url = coc_nvim_1.Uri.file(path_1.default.join(extension.extensionPath, url)).toString();
                        }
                        if (fileMatch[0] === '%') {
...
class SchemaContributor {
    ...
    requestCustomSchemaContent(uri) {
        if (uri) {
            let _uri = coc_nvim_1.Uri.parse(uri);
