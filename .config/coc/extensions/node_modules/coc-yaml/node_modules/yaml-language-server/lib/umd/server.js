(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "request-light", "url", "./languageservice/utils/arrUtils", "./languageservice/yamlLanguageService", "vscode-nls", "./languageservice/services/yamlSchemaService", "./requestTypes", "./languageservice/services/schemaRequestHandler", "./languageservice/utils/paths", "vscode-uri", "./languageservice/utils/schemaUrls"], factory);
    }
    ...
    function validateTextDocument(textDocument) {
        ...
        exports.customLanguageService.doValidation(textDocument, isKubernetes(textDocument)).then(function (diagnosticResults) {
            const diagnostics = [];
            ...
            connection.sendDiagnostics({
                ...
                diagnostics: arrUtils_1.removeDuplicatesObj(diagnostics),
            });
        }, function () {
            // ignore
        });
    ...
    connection.onInitialized(() => {
        if (hasWorkspaceFolderCapability) {
            connection.workspace.onDidChangeWorkspaceFolders((changedFolders) => {
                workspaceFolders = paths_1.workspaceFoldersChanged(workspaceFolders, changedFolders);
            });
        }
    });
    /**
    ...
    connection.onNotification(requestTypes_1.DynamicCustomSchemaRequestRegistration.type, () => {
        const schemaProvider = ((resource) => {
            return connection.sendRequest(requestTypes_1.CustomSchemaRequest.type, resource);
        });
