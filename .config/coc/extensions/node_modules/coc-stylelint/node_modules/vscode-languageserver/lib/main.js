...
function createConnection(arg1, arg2, arg3, arg4) {
    ...
    if (vscode_languageserver_protocol_1.ConnectionStrategy.is(arg1) || vscode_languageserver_protocol_1.ConnectionOptions.is(arg1)) {
        options = arg1;
    }
    else {
        input = arg1;
...
function _createConnection(input, output, options, factories) {
    ...
    const connection = vscode_languageserver_protocol_1.createProtocolConnection(input, output, logger, options);
